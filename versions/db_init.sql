...
START TRANSACTION;
USE `products`;
INSERT INTO `product_type_enforcer` (`product_type`) VALUES ('thi');
INSERT INTO `product_type_enforcer` (`product_type`) VALUES ('mon');
INSERT INTO `product_type_enforcer` (`product_type`) VALUES ('lic');
INSERT INTO `product_type_enforcer` (`product_type`) VALUES ('aio');
INSERT INTO `product_type_enforcer` (`product_type`) VALUES ('acc');
INSERT INTO `product_type_enforcer` (`product_type`) VALUES ('lap');
INSERT INTO `product_type_enforcer` (`product_type`) VALUES ('zer');
INSERT INTO `product_type_enforcer` (`product_type`) VALUES ('sub');
...
START TRANSACTION;
USE `products`;
INSERT INTO `thin_client_enforcer` (`product_type`) VALUES ('thn');
